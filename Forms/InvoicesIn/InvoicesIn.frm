...
Private Function AbortProcedure(blnStatus)
    ...
    If Not blnStatus Then
        If MyMsgBox(3, strApplicationName, strStandardMessages(3), 2) Then
            ...
            ClearFields mskDateIssue, mskDateRefersTo, txtExpenseDescription, txtSupplierDescription, txtCodeShortDescriptionA, txtInvoiceNo, txtPaymentTermDescription
            ClearFields grdInvoicesIn
            ClearFields mskTotalNet, mskTotalVAT, mskTotalGross
            DisableFields mskDateIssue, mskDateRefersTo, txtExpenseDescription, txtSupplierDescription, txtCodeShortDescriptionA, txtInvoiceNo, txtPaymentTermDescription
...
Public Function FindExpensesPerVAT(lngTrnID)
    ...
    'Κυρίως διαδικασία
    strSQL = "SELECT ExpensePerVATID, Description,ExpensePerVATPercentID, ExpensePerVATNetAmount, ExpensePerVATVATAmount, ExpensePerVATGrossAmount " _
        & "FROM VATPercents " _
        & "INNER JOIN ExpensesPerVAT ON VATPercents.ID = ExpensesPerVAT.ExpensePerVATPercentID " _
...
Private Function NewRecord()
    ...
    ClearFields grdInvoicesIn
    ClearFields mskTotalNet, mskTotalVAT, mskTotalGross
    EnableFields mskDateIssue, mskDateRefersTo, txtExpenseDescription, txtSupplierDescription, txtCodeShortDescriptionA, txtInvoiceNo, txtPaymentTermDescription
    ...
    With rstExpensesPerVAT
        While Not .EOF
            With grdInvoicesIn
                ...
                .CellValue(lngRow, "Description") = rstExpensesPerVAT!Description
...
Private Function RefreshListWithVATPercents()
    ...
    'Κυρίως διαδικασία
    strSQL = "SELECT * FROM VATPercents ORDER BY Description"
    ...
    With rstRecordset
        ...
        Do While Not .EOF
            lngRow = lngRow + 1
            UpdateProgressBar Me
            grdInvoicesIn.CellValue(lngRow, "VATPercentID") = !ID
            grdInvoicesIn.CellValue(lngRow, "Description") = !Description
            .MoveNext
        Loop
...
Private Function ValidateFields()
    ...
    'Μήκος ημερομηνίας
    If Len(mskDateRefersTo.text) <> 10 Then
        If MyMsgBox(4, strApplicationName, strStandardMessages(2), 1) Then
        End If
        mskDateRefersTo.SetFocus
        Exit Function
...
Public Function SeekRecord(lngTrnID)
    ...
    strSQL = "SELECT " _
        & "Invoices.InvoiceID, Invoices.InvoiceTrnID, Invoices.InvoiceMasterRefersTo, Invoices.InvoiceSecondaryRefersTo, Invoices.InvoiceDateIssue, Invoices.InvoiceDateIn, Invoices.InvoiceCodeID, Invoices.InvoiceNo, Invoices.InvoicePersonID, Invoices.InvoiceDateIssue, InvoiceDateRefersTo, Invoices.InvoiceNo, " _
...
Private Sub Form_Load()
    ...
    ClearFields txtInvoiceID, txtInvoiceTrnID, txtInvoiceCodeID, txtInvoicePersonID, txtInvoiceDateIn, txtCodeLastNo, txtCodeLastDate, txtCodePersonsPlusOrMinus, chkCodeHandID
    ClearFields lblCodeDescription, mskBalance
    ClearFields mskDateIssue, mskDateRefersTo, mskDateRefersTo, txtExpenseDescription, txtSupplierDescription, txtCodeShortDescriptionA, txtInvoiceNo, txtPaymentTermDescription
    ClearFields mskTotalNet, mskTotalVAT, mskTotalGross
    ClearFields grdInvoicesIn
    DisableFields mskDateIssue, mskDateRefersTo, txtExpenseDescription, txtSupplierDescription, txtCodeShortDescriptionA, txtInvoiceNo, txtPaymentTermDescription
    DisableFields cmdIndex(0), cmdIndex(1), cmdIndex(2), cmdIndex(3), cmdIndex(4), cmdIndex(5), cmdIndex(6), cmdIndex(7)
...
Private Sub mskDateRefersTo_GotFocus()
    ...
    If mskDateIssue.text = "" Then
        ClearFields mskDateRefersTo
    End If

    If mskDateRefersTo.text = "" Then
        mskDateRefersTo.text = mskDateIssue.text
    End If
