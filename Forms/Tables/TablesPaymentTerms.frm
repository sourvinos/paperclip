...
Private Function SeekRecord()
    ...
    If MainSeekRecord("CommonDB", "PaymentTerms", "PaymentTermID", grdPaymentTerms.CellValue(grdPaymentTerms.CurRow, 1), True, txtPaymentTermID, txtPaymentTermDescription, txtPaymentTermCreditID) Then
        'Πίστωση
        Set tmpRecordset = CheckForMatch("CommonDB", "YesOrNo", "ID", "Numeric", txtPaymentTermCreditID.text)
...
Private Sub cmdIndex_Click(Index As Integer)
    ...
    Select Case Index
        Case 0
            'Πίστωση
            Set tmpRecordset = CheckForMatch("CommonDB", "YesOrNo", "Description", "String", txtPaymentTermCreditDescription.text)
