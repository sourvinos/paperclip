...
Private Function SeekRecord()
    ...
    If MainSeekRecord("CommonDB", "PaymentWays", "PaymentWayID", grdPaymentWays.CellValue(grdPaymentWays.CurRow, 1), True, txtPaymentWayID, txtPaymentWayDescription, txtPaymentWayCashID) Then
        'Ταμείο
        Set tmpRecordset = CheckForMatch("CommonDB", "YesOrNo", "ID", "Numeric", txtPaymentWayCashID.text)
...
Private Sub cmdIndex_Click(Index As Integer)
    ...
    Select Case Index
        Case 0
            'Ταμείο
            Set tmpRecordset = CheckForMatch("CommonDB", "YesOrNo", "Description", "String", txtPaymentWayCashDescription.text)
