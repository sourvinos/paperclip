...
Private Sub Form_Activate()
    ...
    If Me.Tag = "True" Then
        Me.Tag = "False"
        AddColumnsToGrid grdRevenueSources, False, 25, GetSetting(strApplicationName, "Layout Strings", "grdRevenueSources"), "04NCIID,40NLNDescription", "ID,Ονομασία"
        Me.Refresh
        PopulateGrid
    End If

    'AddDummyLines grdRevenueSources, "99999", "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAΑΑΑΑΑΑΑΑΑΑ"
