...
Function AddGridLines(myGrid As iGrid, myLines As Integer)

    myGrid.AddRow , , , , , , , myLines
...
Function SanitizeString(text)
    ...
    strNewString = Replace(text, Chr(34), Chr(39))
    
    SanitizeString = strNewString
...
Sub LoadMessages()
    ...
    strAppMessages(1) = Chr(13) & "Η γραμμή " 'Η γραμμή 999 είναι λάθος (Συμφωνίες εργαζομένων)
